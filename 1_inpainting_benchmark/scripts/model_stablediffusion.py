...
def load():
    print("[SD-Inpaint-RunwayML] Loading model...")
...
def inpaint(image, mask, prompt, pipe):
    """
    Inpainting avec RunwayML Stable Diffusion Inpainting
...
if __name__ == "__main__":
    ...
    result_image.save("/fsx/jdelavande/inpaint-benchmark-suite/1_inpainting_benchmark/data/results/runwayml_inpaint_result.png")
    print("Inpainting completed and saved as 'runwayml_inpaint_result.png'")
